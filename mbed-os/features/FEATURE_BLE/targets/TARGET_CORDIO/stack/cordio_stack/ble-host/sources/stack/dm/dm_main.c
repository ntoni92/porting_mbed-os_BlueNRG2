...
static const uint8_t dmHciToIdTbl[] =
{
  ...
  DM_ID_SCAN,                                 /* HCI_LE_SCAN_ENABLE_CMPL_CBACK_EVT */
  DM_ID_ADV,                                  /* HCI_LE_ADV_ENABLE_CMPL_CBACK_EVT */
  DM_ID_SCAN,                                 /* HCI_LE_EXT_SCAN_ENABLE_CMPL_CBACK_EVT */
  DM_ID_ADV,                                  /* HCI_LE_EXT_ADV_ENABLE_CMPL_CBACK_EVT */
  DM_ID_ADV_PER,                              /* HCI_LE_PER_ADV_ENABLE_CMPL_CBACK_EVT */
  DM_ID_DEV                                   /* HCI_READ_LOCAL_VER_INFO_CMPL_CBACK_EVT */
};
...
static const uint16_t dmEvtCbackLen[] =
{
  ...
  sizeof(hciReadLocalVerInfo_t),              /* DM_READ_LOCAL_VER_INFO_IND */
